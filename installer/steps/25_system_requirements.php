...
if ($_REQUEST['lang'] == "de") {
    ...
    <div class="sp_phpversion">mindestens PHP Version 5.6</div>
    ...
    <div class="sp_phpversion">Версия на PHP най-малко 5.6</div>
    ...
    <div class="sp_phpversion">at least PHP version 5.6</div>
