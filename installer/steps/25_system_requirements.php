...
if ($_REQUEST['lang'] == "de") {
    ...
    <div class="sp_phpversion">mindestens PHP Version 5.4</div>
    ...
    <div class="sp_phpversion">Версия на PHP най-малко 5.4</div>
    ...
    The following conditions must be met:  <?php //echo PHP_VERSION_ID ?> <br/>
    <div class="sp_phpversion">at least PHP version 5.4</div>
