...
Choose another table prefix or delete existing tables with this prefix in order to allow Kimai to perform a clean installation.')
    ...
    'authsettings' => array(
        'authenticator' => 'Authentication method used (kimai, ldap, ldapadvanced)',
        'kimai_auth_desc' => 'kimai authentication is the built-in authentication and does not require any additional settings',
        'http_auth_desc' => 'http authentication uses the web server\'s built-in authentication method.  It requires a .htaccess and .htpasswd file (see: http://www.kimai.org/documentation/administrator/authenticator.html)',
        'host' => 'Hostname',
        'host_desc' => 'LDAP Serevr (ldap://localhost, ldaps://localhost)',
        'bindDN' => 'Bind DN',
        'bindDN_desc' => 'Account used to bind to LDAP "CN=ldapuser,CN=Users,DC=domain,DC=org"',
        'bindPW' => 'Bind Password',
        'bindPW_desc' => 'Password used to bind to LDAP',
        'searchBase' => 'LDAP Search Base',
        'searchBase_desc' => 'Where to start searching LDAP (dc=domain,dc=org)',
        'userFilter' => 'User Filter',
        'userFilter_desc' => 'uid=%s',
        'groupFilter' => 'Group Filter',
        'groupFilter_desc' => 'memberUid=%1$s',
        'usernameAttribute' => 'Username Attribute',
        'usernameAttribute_desc' => 'uid',
        'commonNameAttribute' => 'Common Name Attribute',
        'commonNameAttribute_desc' => 'cn',
        'groupidAttribute' => 'Group ID Attribute',
        'groupidAttribute_desc' => 'cn',
        'mailAttribute' => 'Mail attribute',
        'mailAttribute_desc' => 'mail',
        'allowedGroupIds' => 'Allowed LDAP Groups',
        'allowedGroupIds_desc' => 'Time Entry',
        'forceLowercase' => 'Force lowercase',
        'forceLowercase_desc' => true,
        'nonLdapAccounts' => 'Non-Ldap Accounts',
        'nonLdapAccounts_desc' => 'admin',
        'autocreateUsers' => 'Auto Create Users',
        'autocreateUsers_desc' => true,
        'defaultGlobalRoleName' => 'Global Role Names',
        'defaultGlobalRoleName_desc' => 'User',
        'createGroupMembershipsOnLogin' => 'Create Groups on Login',
        'createGroupMembershipsOnLogin_desc' => true,
        'defaultGroupMemberships' => 'Default Group Membership',
        'defaultGroupMemberships_desc' => 'User',
        'enhancedIdentityPrivacy' => 'Enhanced Identity Privacy',
        'enhancedIdentityPrivacy_desc' => 'Enhanced Identity Privacy',
        'phpAuthUser' => 'PHP Auth User',
        'phpAuthUser_desc' => 'PHP Auth User (true or false)',
        'remoteuser' => 'Remote User',
        'remoteuser_desc' => 'Remote User',
        'redirectRemoteUser' => 'Redirect Remote User',
        'redirectRemoteUser_desc' => 'Redirect Remote User',
        'allowAutoLogin' => 'Allow Auto Login',
        'allowAutoLogin_desc' => 'Allow Auto Login',
        'usernameprefix' => 'Username Prefix',
        'usernameprefix_desc' => 'Ldap data that prefixes the username (ex. cn=)',
        'usernamepostfix' => 'Username suffix',
        'usernamepostfix_desc' => 'Ldap data that is after the username (ex. dc=domain,dc=org)',
    ),
);
