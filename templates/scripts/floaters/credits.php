<div id="floater_innerwrap">
    ...
    <div class="floater_content" style="margin:10px">
        ...
        <p>
            ...
            <a href="http://forum.kimai.org/index.php?board=10.0">Friendly Hacks</a>
        </p>
        <p>
            <strong>
            <?php
        ...
        <p>
            ...
            echo sprintf(
                ...
                'https://github.com/kimai/kimai/tree/master/core/language'
            );
            ?>
        </p>
        <p>
        ...
        <p>
            <strong><?php echo $this->kga['lang']['credits_libs']?></strong>
             ...
             <a href="http://www.phpconcept.net" rel="nofollow" target="_blank">PclZip</a>,
