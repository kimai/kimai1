...
<title>Kimai <?php echo $this->_tpl_vars['kga']['lang']['login']; ?>
</title>
...
<?php if ($this->_tpl_vars['kga']['check_at_startup']): ?>
<script type="text/javascript" src="js/main.js"></script>
<?php endif; ?>
<?php echo '<script type=\'text/javascript\'>function setfocus() { document.form1.name.focus(); }</script>
...
<?php if (! $this->_tpl_vars['kga']['virtual_users']): ?><body onLoad='setfocus();'>
<?php else: ?><body>
<?php endif; ?>