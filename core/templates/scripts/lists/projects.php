        ...
        foreach ($projects as $project)
        {
            ...
            <tr id="row_project" data-id="<?php echo $project['projectID']?>" class="project customer<?php echo $project['customerID']?> <?php echo $this->cycle(array('odd','even'))->next()?>" >
              ...
              <td nowrap class="option">
                ...
                <a href ="#" class="preselect" onClick="buzzer_preselect_project(<?php echo $project['projectID']?>,'<?php echo $this->jsEscape($project['name'])?>','<?php echo $this->jsEscape($project['comment'])?>',<?php echo $project['customerID']?>,'<?php echo $this->jsEscape($project['customerName'])?>'); return false;" id="ps<?php echo $project['projectID']?>">
            ...
            <td width="100%" class="projects" onmouseover="lists_change_color(this,true);" onmouseout="lists_change_color(this,false);" onClick="buzzer_preselect_project(<?php echo $project['projectID']?>,'<?php echo $this->jsEscape($project['name'])?>','<?php echo $this->jsEscape($project['comment'])?>',<?php echo $project['customerID']?>,'<?php echo $this->jsEscape($project['customerName'])?>'); lists_reload('activity'); return false;">
