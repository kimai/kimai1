...
-->
<p>
    <strong>Kimai <span style="color:red"><?php echo $this->kga['status']?></span> <?php echo $this->kga['version'],'.',$this->kga['revision']?></strong> - &copy; <?php $this->devtimespan?> the <a href="http://www.kimai.org" target="_blank">Kimai Team</a><br />
    This software is provided under the terms and conditions of the <a href="COPYING" target="_blank">General Public License Version 3</a><br />
    Powered by 
