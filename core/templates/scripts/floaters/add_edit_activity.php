...
<div id="floater_innerwrap">
    ...
    <div id="floater_handle">
        <span id="floater_title"><?php if ($id) echo $this->kga['lang']['edit'], ': ', $this->kga['lang']['activity']; else echo $this->kga['lang']['new_activity'];?></span>
        <div class="right">
 ...
 echo $this->formHidden('activityGroups[]', $this->selectedGroups[0], ,array('id' => 'activityGroups'));
    ...
    <fieldset id="projects">
                <ul>
                    ...
                    <li>
                        <label for="projects"><?php echo $this->kga['lang']['projects']?>:</label>
