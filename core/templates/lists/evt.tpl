...
{/if}
                        <a href ="#" class="preselect" onClick="lists_preselect('evt',{$arr_evt[row].evt_ID},'{$arr_evt[row].evt_name}',0,0); return false;" id="ps{$arr_evt[row].evt_ID}"><img src='../skins/{$kga.conf.skin}/grfx/preselect_off.png' width='13' height='13' alt='{$kga.lang.select}' title='{$kga.lang.select} (ID:{$arr_evt[row].evt_ID})' border='0' /></a>
                    </td>

                    <td width="100%" class="events" onClick="lists_preselect('evt',{$arr_evt[row].evt_ID},'{$arr_evt[row].evt_name}',0,0); return false;" onmouseover="lists_change_color(this,true);" onmouseout="lists_change_color(this,false);">
