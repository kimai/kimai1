...
$.subscribe('tabs', function (_, extensionId, tabId) {
    if (extensionId == 'adminPanel_extension') {
...
function adminPanel_extension_refreshSubtab(tab) {
    ...
    function(data) {
        switch(tab) {
            case "customers":  	    target = "#adminPanel_extension_s1"; break
            case "projects": 	    target = "#adminPanel_extension_s2"; break
            case "activities": 	    target = "#adminPanel_extension_s3"; break
            case "users":  	        target = "#adminPanel_extension_s4"; break
            case "groups":  	    target = "#adminPanel_extension_s5"; break
            case "globalRoles":     target = "#adminPanel_extension_s6"; break
            case "membershipRoles": target = "#adminPanel_extension_s7"; break
            case "status":          target = "#adminPanel_extension_s8"; break
            case "advanced":  	    target = "#adminPanel_extension_s9"; break
            case "database":   	    target = "#adminPanel_extension_s10"; break
        }
        $(target).html(data);
    });
}
