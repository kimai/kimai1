<a href="#" onClick="floaterShow('floaters.php','add_edit_project',0,0,650,200); $(this).blur(); return false;"><img src="../skins/<?php echo $this->escape($this->kga['conf']['skin'])?>/grfx/add.png" width="22" height="16" alt="<?php echo $this->kga['lang']['new_project']?>"></a> <?php echo $this->kga['lang']['new_project']?>
<br/><br/>
...
<?php foreach ($this->projects as $row):
  if (!$row['visible'] && $row['zeit'] == "0:00") continue; ?>
                <tr class="<?php echo $this->cycle(array("odd","even"))->next()?>">
                    ...
                    <td class="option">
                        ...
                        <a href="#" id="delete_project<?php echo $row['projectID']?>" onClick="adminPanel_extension_deleteProject(<?php echo $row['projectID']?>)">
                          <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin'])?>/grfx/button_trashcan.png" title="<?php echo $this->kga['lang']['delete_project']?>" width="13" height="13" alt="<?php echo $this->kga['lang']['delete_project']?>" border="0"></a>
                    </td>
