...
<?php if ($grouparray['count_users'] == 0): ?>
            <a href="#" onClick="adminPanel_extension_deleteGroup(<?php echo $grouparray['groupID']?>)">
                <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin'])?>/grfx/button_trashcan.png" title="<?php echo $this->kga['lang']['delete_group']?>" width="13" height="13" alt="<?php echo $this->kga['lang']['delete_group']?>" border="0"></a>
<?php else: ?>
