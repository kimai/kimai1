...
<?php foreach ($this->groups as $grouparray): ?>
...
<?php endif; ?>   
        ...
        <td>
            <a href="#" onClick="adminPanel_extension_editGroup('<?php echo $grouparray['groupID']?>'); $(this).blur(); return false;">
                <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin'])?>/grfx/edit2.gif" title="<?php echo $this->kga['lang']['editGroup']?>" width="13" height="13" alt="<?php echo $this->kga['lang']['editGroup']?>" border="0">
            </a>
...
<?php if ($grouparray['count_users'] == 0): ?>
            <a href="#" onClick="adminPanel_extension_deleteGroup(<?php echo $grouparray['groupID']?>)">
                <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin'])?>/grfx/button_trashcan.png" title="<?php echo $this->kga['lang']['delete_group']?>" width="13" height="13" alt="<?php echo $this->kga['lang']['delete_group']?>" border="0">
            </a>
<?php else: ?>
...
<?php endif; ?>   
        ...
        <td>
            <?php foreach ($grouparray['leader_name'] as $leader)
