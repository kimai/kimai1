...
{if $curr_user == $arr_usr[userarray].usr_name}
            <strong style="color:#00E600">{$arr_usr[userarray].usr_name}</strong>
{else}
    {if $arr_usr[userarray].usr_trash}<span style="color:#999">{/if}
            {$arr_usr[userarray].usr_name}
...
{if $curr_user != $arr_usr[userarray].usr_name}            
            <a href="#" onClick="switchUsr('{$arr_usr[userarray].usr_ID}'); return false;">
                <img src="../skins/{$kga.conf.skin}/grfx/auge.png" title="{$kga.lang.switchusr}" width="16" height="13" alt="{$kga.lang.switchusr}" border="0">
            </a>
{else} 
            <img src="../skins/{$kga.conf.skin}/grfx/auge_.gif" title="{$kga.lang.switchusr}" width="16" height="13" alt="{$kga.lang.switchusr}" border="0">
{/if}

            &nbsp;
     
            <a href="#" onClick="backupUsr({$arr_usr[userarray].usr_ID}); return false;">
                <img src="../skins/{$kga.conf.skin}/grfx/button_backup.gif" title="{$kga.lang.backupusr}" width="12" height="13" border=0 alt="{$kga.lang.backupusr}">
            </a>
...
{if $arr_usr[userarray].usr_mail}            
            <a href="mailto:{$arr_usr[userarray].usr_mail}">
                <img src="../skins/{$kga.conf.skin}/grfx/button_mail.gif" title="{$kga.lang.mailusr}" width="12" height="13" alt="{$kga.lang.mailusr}" border="0">
            </a>           
{else} 
            <img src="../skins/{$kga.conf.skin}/grfx/button_mail_.gif" title="{$kga.lang.mailusr}" width="12" height="13" alt="{$kga.lang.mailusr}" border="0">
{/if}
...
{if $curr_user != $arr_usr[userarray].usr_name}
            <a href="#" id="delete_usr{$arr_usr[userarray].usr_ID}" onClick="ap_ext_deleteUser({$arr_usr[userarray].usr_ID})">
                <img src="../skins/{$kga.conf.skin}/grfx/button_trashcan.png" title="{$kga.lang.delusr}" width="13" height="13" alt="{$kga.lang.delusr}" border="0">
            </a>
{else} 
            <img src="../skins/{$kga.conf.skin}/grfx/button_trashcan_.png" title="{$kga.lang.delusr}" width="13" height="13" alt="{$kga.lang.delusr}" border="0">
{/if}
...
{if $arr_usr[userarray].usr_sts == 0}
            <img src='../skins/{$kga.conf.skin}/grfx/crown.png' alt='{$kga.lang.adminusr}' title='{$kga.lang.adminusr}' border="0">
{/if}
...
{if $arr_usr[userarray].usr_sts == 2}
            <img src='../skins/{$kga.conf.skin}/grfx/user.gif' alt='{$kga.lang.regusr}' title='{$kga.lang.regusr}' border="0">
{/if}
...
{if $arr_usr[userarray].usr_active == 1}
    {if $curr_user != $arr_usr[userarray].usr_name}
            <a href="#" id="ban{$arr_usr[userarray].usr_ID}" onClick="ap_ext_banUser('{$arr_usr[userarray].usr_ID}'); return false;">
                <img src='../skins/{$kga.conf.skin}/grfx/jipp.gif' alt='{$kga.lang.activeusr}' title='{$kga.lang.activeusr}' border="0" width="16" height="16" />
            </a>
    {else}
            <img src='../skins/{$kga.conf.skin}/grfx/jipp_.gif' alt='{$kga.lang.activeusr}' title='{$kga.lang.activeusr}' border="0" width="16" height="16" />
    {/if}
{/if}
...
{if $arr_usr[userarray].usr_active == 0}
            <a href="#" id="ban{$arr_usr[userarray].usr_ID}" onClick="ap_ext_unbanUser('{$arr_usr[userarray].usr_ID}'); return false;">
                <img src='../skins/{$kga.conf.skin}/grfx/lock.png' alt='{$kga.lang.bannedusr}' title='{$kga.lang.bannedusr}' border="0" width="16" height="16" />
            </a>
{/if}
...
{if $arr_usr[userarray].usr_grp == 1}
            <span style="color:red">{$arr_usr[userarray].grp_name}</span>
{else}
            {$arr_usr[userarray].grp_name}
{/if}
        </td>      
{*########## Group cells ##########*}
...
<p><strong>{$kga.lang.hint}</strong> {$kga.lang.usr_caution1} '{$curr_user}' {$kga.lang.usr_caution2}</p>