...
{if $arr_grp[grouparray].grp_ID == 1}            
            <span style="color:red">{$arr_grp[grouparray].grp_name}</span>
{else}
            {$arr_grp[grouparray].grp_name}
{/if}            
        </td>
...
{*
            <a href="#" onClick="switchGrp('{$arr_grp[grouparray].grp_ID}'); return false;">
                <img src="../skins/{$kga.conf.skin}/grfx/auge.png" title="{$kga.lang.switchgrp}" width="16" height="13" alt="{$kga.lang.switchgrp}" border="0">
            </a>
            
            &nbsp;
            
            <a href="#" onClick="backupGrp({$arr_grp[grouparray].grp_ID}); return false;">
                <img src="../skins/{$kga.conf.skin}/grfx/button_backup.gif" title="{$kga.lang.backupgrp}" width="12" height="13" border="0" alt="{$kga.lang.backupgrp}">
            </a>

            &nbsp;
            
            <a href="mailto:{$arr_grp[grouparray].grp_mail}">
                <img src="../skins/{$kga.conf.skin}/grfx/button_mail_.gif" title="{$kga.lang.mailgrp}" width="12" height="13" alt="{$kga.lang.mailgrp}" border="0">
            </a>
...
{if $arr_grp[grouparray].count_users == 0}            
            <a href="#" onClick="ap_ext_deleteGroup({$arr_grp[grouparray].grp_ID})">
                <img src="../skins/{$kga.conf.skin}/grfx/button_trashcan.png" title="{$kga.lang.delgrp}" width="13" height="13" alt="{$kga.lang.delgrp}" border="0">
            </a>
{else}
             <img src="../skins/{$kga.conf.skin}/grfx/button_trashcan_.png" title="{$kga.lang.delgrp}" width="13" height="13" alt="{$kga.lang.delgrp}" border="0">
{/if}            
