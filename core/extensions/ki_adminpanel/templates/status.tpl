<form>
    ...
    <input class='btn_ok' type=submit value="{$kga.lang.new_status}" onclick="ap_ext_newStatus(); return false;">
</form>
<br />
<table>
    <thead>
...
{section name=statusarray loop=$arr_status}
    <tr class='{cycle values="even,odd"}'>
        ...
        <td>{strip}
            <a href="#" onClick="ap_ext_editStatus('{$arr_status[statusarray].status_id}'); $(this).blur(); return false;">
...
{if $arr_status[statusarray].count_zef == 0}            
            <a href="#" onClick="ap_ext_deleteStatus({$arr_status[statusarray].status_id})">
