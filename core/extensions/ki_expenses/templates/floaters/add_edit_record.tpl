            ...
            <fieldset id="general">
                ...
                <ul>
                   ...
                   <li>
                       ...
                       <br/>
                       <input type="input" style="margin-left:115px;width:395px;margin-top:3px" tabindex="2" size="10" maxlength="10" name="filter" id="filter" onkeyup="filter_selects('add_edit_exp_pct_ID', this.value); exp_add_edit_validate();"/>
                   </li>
