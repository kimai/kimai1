    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td class="budget {if $disabled_columns.budget}disabled{/if}"><a onClick="xp_toggle_column('budget');">{$kga.lang.budget}</a></td>
                <td class="approved {if $disabled_columns.approved}disabled{/if}"><a onClick="xp_toggle_column('approved');">{$kga.lang.approved}</a></td>
                <td class="status {if $disabled_columns.status}disabled{/if}"><a onClick="xp_toggle_column('status);">{$kga.lang.status}</a></td>
                <td class="billable {if $disabled_columns.billable}disabled{/if}"><a onClick="xp_toggle_column('billable');">{$kga.lang.billable}</a></td>
                ...
                <td class="description {if $disabled_columns.description}disabled{/if}"><a onClick="xp_toggle_column('description');">{$kga.lang.description}</a></td>
