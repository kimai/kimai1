...
<html>
<head>
	<title><?php echo $this->kga['lang']['export_extension']['time_period']?>: <?php echo $this->escape($this->timespan) ?></title>
	<meta charset="utf-8" />
	...
	<table border="1">
		...
		<?php foreach ($this->summary as $row): ?>
			<tr>
				...
				<?php endif; ?>
				<?php if (isset($this->columns['wage'])): ?>
					<td><?php echo $this->escape(number_format($row['wage'], 2, $this->kga['conf']['decimalSeparator'], ""))?></td>
				<?php endif; ?>
				<?php if (isset($this->columns['budget'])): ?>
					<td><?php echo $this->escape(number_format($row['budget'], 2, $this->kga['conf']['decimalSeparator'], ""))?></td>
				<?php endif; ?>
				<?php if (isset($this->columns['approved'])): ?>
					<td><?php echo $this->escape(number_format($row['approved'], 2, $this->kga['conf']['decimalSeparator'], ""))?></td>
				<?php endif; ?>
			</tr>
		<?php endforeach; ?>
		<tr>
			<td><i><?php echo $this->kga['lang']['export_extension']['finalamount']?></i></td>
			<?php if (isset($this->columns['dec_time'])): ?>
...
<table border="1">
	...
	<?php foreach ($this->exportData as $row): ?>
		<tr>
			...
			<?php if (isset($this->columns['time'])): ?>
				<td><?php echo $row['duration'] ? $row['formattedDuration'] : "&ndash;:&ndash;&ndash;" ?></td>
			<?php endif; ?>
			<?php if (isset($this->columns['dec_time'])): ?>
				<td><?php echo $row['decimalDuration'] ? $this->escape(str_replace('.', $this->kga['conf']['decimalSeparator'], $row['decimalDuration'])) : "&ndash;:&ndash;&ndash;" ?></td>
			<?php endif; ?>
			<?php if (isset($this->columns['rate'])): ?>
				<td><?php echo $this->escape(str_replace('.', $this->kga['conf']['decimalSeparator'], $row['rate'])) ?></td>
			<?php endif; ?>
			<?php if (isset($this->columns['wage'])): ?>
				<td><?php echo $row['wage'] ? $this->escape(str_replace('.', $this->kga['conf']['decimalSeparator'], $row['wage'])) : "&ndash;" ?></td>
			<?php endif; ?>
			<?php if (isset($this->columns['budget'])): ?>
	...
	<?php if ($this->timeSum > 0 || $this->wageSum > 0): ?>
		<tr>
			<td colspan="<?php echo count($this->columns)?>"><?php echo $this->kga['lang']['export_extension']['finalamount']?></td>
		</tr>
		<tr>
			...
			<?php if (isset($this->columns['wage'])): ?><td><?php echo $this->escape(number_format($this->wageSum, 2, $this->kga['conf']['decimalSeparator'], "")); ?></td><?php endif; ?>
			<?php if (isset($this->columns['budget'])): ?><td><?php echo $this->escape(number_format($this->budgetSum, 2, $this->kga['conf']['decimalSeparator'], "")); ?></td><?php endif; ?>
			<?php if (isset($this->columns['approved'])): ?><td><?php echo $this->escape(number_format($this->approvedSum, 2, $this->kga['conf']['decimalSeparator'], "")); ?></td><?php endif; ?>
