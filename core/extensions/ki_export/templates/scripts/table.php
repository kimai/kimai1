 ...
 <?php if ($isExpense):?> expense<?php endif; ?>">
                    ...
                    ">
                        ...
                        <a href ="#" class="preselect_lnk" 
                            onClick="buzzer_preselect('project',<?php echo $row['projectID']?>,'<?php echo $this->jsEscape($row['projectName'])?>',<?php echo $row['customerID']?>,'<?php echo $this->jsEscape($row['customerName'])?>'); 
                            return false;">
