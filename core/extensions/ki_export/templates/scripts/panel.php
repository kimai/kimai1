			...
			<div class="w">
				<div class="c">
					...
					<div id="export_extension_tab_timeformat">
						<span><?php echo $this->kga['lang']['export_extension']['timeformat']?>:<a href="#" class="helpfloater"><?php echo $this->kga['lang']['export_extension']['export_timeformat_help']?></a></span>
						...
						<span><?php echo $this->kga['lang']['export_extension']['dateformat']?>:<a href="#" class="helpfloater"><?php echo $this->kga['lang']['export_extension']['export_timeformat_help']?></a></span>
