...
#xptable tr.odd td.comment,
#xptable tr.odd td.trackingNumber,
#xptable tr.odd td.location {
    background: #CFE3F5;
}

#xptable tr.even td.comment,
#xptable tr.even td.trackingNumber,
#xptable tr.even td.location {
    background: #ECF7FD;
}
#xptable tr.even.expense td {
    background: #E5FFBF;
}

#xptable tr.odd.expense td {
    background: #DCF4B7;
}

#xptable tr.odd.expense td.comment,
#xptable tr.odd.expense td.trackingNumber,
#xptable tr.odd.expense td.location {
    background: #A3F1A6;
}

#xptable tr.even.expense td.comment,
#xptable tr.even.expense td.trackingNumber,
#xptable tr.even.expense td.location {
    background: #C8F1CC;
}

#xptable tr.odd td.cleared {
    background: #6E7882;
}

#xptable tr.even td.cleared {
    background: #86939F;
}
...
#xptable tr.even td.time {
    background: #A4E7A5;
}

#xptable tr.odd td.time {
    background: #64BF61;
}

#xptable tr.active td.time {
    background: #F00;
}

#xptable tr.expense td.time {
...
div.ki_export>div#xp>#xptable>table>tbody>tr>td.cleared {
    border-right: none;
}
