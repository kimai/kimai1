...
$this->floater()
    ->setTitle($title)
    ->setFormAction('../extensions/ki_timesheets/processor.php')
    ->setFormId('ts_ext_form_add_edit_timeSheetEntry')
    ->addTab('general', $this->translate('general'))
    ->addTab('extended', $this->translate('advanced'))
    ->addTab('budget', $this->translate('budget'));
 ...
 */ ?>
    ...
    <?php echo $this->floater()->tabContentBegin('budget'); ?>
        <ul>
           <li>
           ...
           <li>
               <table>
                   <tr><td align="right"><?php echo $this->kga['lang']['budget_activity']?>:</td><td>
