...
"nopasswordset"     => "Sin contraseña establecida!",
...
"ac_error"          => "Entrada automáticamente continuada con error (timespan demasiado largo).",
...
"rename_caution_after_username"      => "debe entrar de nuevo en el sistema con el nuevo nombre de usuario!",
...
"selectedForRecording"           => "Seleccionar para grabar::",
...
"tab_filter"	 		   => "Filtro",
"tab_location"	 		   => "Localización",
"tab_timeformat"	 	   => "Formato de tiempo",

"cleared_all"	 		   => "todo",
"cleared_cleared" 		   => "sólo limpiados",
"cleared_open"	 		   => "sólo abiertos",
"stdrd_location"  		   => "Localización por defecto",
"timeformat"	     	   => "Formato detiempo",
...
"print"         	       => "Imprimir",
"export_timeformat_help"   => "Ahuda del formato de tiempo",
