...
"def_pctID"         => "Sjálfvalið verkefna ID",
"def_kndID"         => "Sjálfvalið viðskiptavinar ID",
"def_evtID"         => "Sjálfvalið atvika ID",
...
"skin"              => "Útlit",
"erase"             => "Eyða færslu",
"new_knd"           => "Bæta við viðskiptavini",
"new_pct"           => "Bæta við verkefni",
"new_evt"           => "Bæta við verki",
...
"regusr"            => "Venjulegur notandi",
"adminusr"          => "Stjórnandi",
"editusr"           => "Breyta notenda",
"editgrp"           => "Breyta hóp",
"delgrp"            => "Eyða hóp",
"delpct"            => "Eyða verkefni",
"delknd"            => "Eyða fyrirtæki",
"delevt"            => "Eyða verki",
"switchusr"         => "Tengjast þessum notenda",
"backupusr"         => "Afrita notenda",
"mailusr"           => "Senda notenda tölvupóst",
"delusr"            => "Eyða þessum notenda",
"bannedusr"         => "Bannaður notandi - Smelltu hér til að virkja",
"activeusr"         => "Virkur notandi - Smelltu hér til að banna",
"changegrp"         => "Breyta hóp",
"members"           => "Meðlimir",
"groupleader"       => "Hópstjóri",
...
"ctype2"            => "Viðvörun!",
"hint"              => "Ábending:",
"usr_caution1"      => "Ef þú breytir notendanafni á",
"usr_caution2"      => "þá verður þú að innskrá þig strax aftur með nýja notendanafninu!",
...
"flip_pct_display"  => "Raða verkefnatöflu eftir viðskiptavinum",
"pct_comment_flag"  => "Alltaf sýna athugasemdir með verkefnum",
"showIDs"           => "Sýna auðkenni",
"error"             => "Villa!",
"checkupdate"       => "Leita að uppfærslu",


"selectR"           => "Valið fyrir skráningu:",
"selectKND"         => "V:",
"selectPCT"         => "V:",
"selectEVT"         => "V:",


"testKND"           => "Prufu-Viðskiptavinur",
"testPCT"           => "Prufu-Verkefni",
"testEVT"           => "Prufa",
