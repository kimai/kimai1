...
"def_pctID"         => "Identifiant projet par d&eacute;fault",
...
"construction"      => "sous construction...",
...
"cookiewarning"     => "Cookies must be accepted! Turn Cookies on before you proceed.",
"JSwarning"         => "JavaScript must be turned on! This version doesn't work without it.",
...
"update"            => "The database structure of the installed Kimai version has to be updated.<br />We recommend to backup your recorded tasks to make sure no data gets lost<br />during the update process.",
...
"delevt"            => "delete task",
"switchusr"         => "Switch to this user",
"backupusr"         => "Make backup of this user",
"mailusr"           => "Send email to this user",
"delusr"            => "Delete this user",
"bannedusr"         => "Banned user - click to reactivate",
"activeusr"         => "Activ user - click to ban",
...
"selectR"           => "Selected for recording:",
"selectKND"         => "C:",
"selectPCT"         => "P:",
"selectEVT"         => "T:",
