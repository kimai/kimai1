...
"ctype2"            => "警告",
"hint"              => "命中:",
"usr_caution1"      => "如果要更改的账户名是",
"usr_caution2"      => "新账户重新登录才能生效!",
...
"flip_pct_display"  => "所有客户的项目列表",
"pct_comment_flag"  => "总是在项目旁边显示评论信息",
"showIDs"           => "显示全部编号",
"error"             => "错误记录!",
"checkupdate"       => "锁住更新",
...
"budget_event" 		=> "事件预算",
"budget_event_used" => "已用时间预算",
"budget_event_approved" => "预算标准",
"budget_minus"		=> "预算超支",
"wage"              => "工资",
