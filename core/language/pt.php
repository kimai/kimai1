...
"plzChoose"         => "por favor selecione",
"noEntries"         => "Não existem entradas a registrar...",
"recordAgain"       => "Grave este evento novamente",
"comment"           => "Comentário/notas",
"zlocation"         => "Location",
"trackingnr"        => "Tracking Number",
"cookiewarning"     => "Permissões de Cookies ser activadas!.Por favor edite esta opção no seu browser antes de continuar.",
...
"tryAgain"          => "Tente novamente/ perdeu a password?",
"back"              => "Voltar á janela de login.",
"bye"               => "Até breve!",
"login"             => "Login",
"logout"            => "Logout",
"loggedon"          => "Utilizador:",
