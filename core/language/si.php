...
"def_pctID"         => "privzet ID projekta",
"def_kndID"         => "privzet ID stranke",
"def_evtID"         => "privzet ID dogodka",
...
"skin"              => "Preobleka",
"erase"             => "Izbriši vnos",
"new_knd"           => "Dodaj stranko",
"new_pct"           => "Dodaj projekt",
"new_evt"           => "Dodaj opravilo",
...
"comment"           => "Komentar",
"zlocation"         => "Lokacija",
"trackingnr"        => "Številka za sledenje",
...
"defaultgrp"        => "Privzeto (0)",
"regusr"            => "Navadni uporanik",
"adminusr"          => "Uporabnik administrator",
"editusr"           => "Uredi uporabnika",
"editgrp"           => "Uredi skupino",
"delgrp"            => "izbriši skupino",
"delpct"            => "izbriši projekt",
"delknd"            => "izbriši stranko",
"delevt"            => "izbriši opravilo",
"switchusr"         => "Preklopi na tega uporabnika",
"backupusr"         => "Naredi varnostno kopijo tega uporabnika",
"mailusr"           => "Pošlji elektronsko sporočilo temu uporabniku",
"delusr"            => "Izbriši tega uporabnika",
"bannedusr"         => "Ukini uporabnika - klikni za ponovno aktivacijo",
"activeusr"         => "Aktivni uporabnik - klikni za ukinitev",
"changegrp"         => "Spremeni skupino",
"members"           => "Člani",
"groupleader"       => "Vodja skupine",
...
"ctype2"            => "Pozor!",
"hint"              => "Namig:",
"usr_caution1"      => "Če spremenite geslo od",
"usr_caution2"      => "se odjavite in ponovno prijavite z novim geslom!",
...
"flip_pct_display"  => "Naroči projektno vsebino pri stranki",
"pct_comment_flag"  => "Vedno prikaži komentarje pri projektih",
"showIDs"           => "Prikaži IDs",
"error"             => "Pojavila se je napaka!",
"checkupdate"       => "Poišči posodobitve",

"selectR"           => "Pripravljeno na snemanje:",
"selectKND"         => "C:",
"selectPCT"         => "P:",
"selectEVT"         => "T:",

"testKND"           => "Testiraj-Stranka",
"testPCT"           => "Testiraj-Projekt",
"testEVT"           => "testiranje",
